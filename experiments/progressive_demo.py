...
if __name__ == "__main__":
    ...
    timings_df = pd.read_csv(outputs_dir.joinpath("prev-res/batch-1_timings.csv"))    
    print(timings_df.head())
    timings_df = timings_df.pivot(index=["seed_data", "step_l", "step_r"], columns="method_id", values="time_secs")
    timings_df["batched_eid_cumsum"] = timings_df["batched"].cumsum()
    timings_df["progressive_eid_cumsum"] = timings_df["progressive"].cumsum()
