...
from contour_depth.visualization import plot_clustering, plot_contour_boxplot, spaghetti_plot, plot_red, sort_red, plot_clustering_eval
...
if __name__ == "__main__":
    ...
    fig, ax = plt.subplots()
    spaghetti_plot(masks, 0.5, img, arr=np.zeros(sorted_labs.size), highlight=to_highlight, ax=ax)#, img)
    plt.show()
